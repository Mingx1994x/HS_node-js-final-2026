...
const CreditPackageOrder = require("../entities/creditPackageOrders.entity");
const CourseBooking = require("../entities/courseBookings.entity");
...
const AppDataSource = new DataSource({
  ...
  entities: [Skill, CreditPackage, CreditPackageOrder, User, Coach, CoachSkill, Course, CourseBooking],
