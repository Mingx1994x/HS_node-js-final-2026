...
const { createCoachRole, getCoachProfile, updateCoachProfile, getCoachRevenue } = require('../controllers/coaches.controller');
...
const { idParamSchema, revenueQuerySchema } = require('../schemas/baseSchema');
...
router.get('/revenue', isAuth, isCoach, validateQuery(revenueQuerySchema), getCoachRevenue);
